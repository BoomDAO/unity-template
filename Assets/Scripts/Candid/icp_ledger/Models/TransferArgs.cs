...
namespace Candid.IcpLedger.Models
{
	public class TransferArgs
	{
		...
		public TransferArgs(Memo memo, Tokens amount, Tokens fee, OptionalValue<SubAccount> fromSubaccount, AccountIdentifier to, OptionalValue<TimeStamp> createdAtTime)
		{
			this.Memo = memo;
			this.Amount = amount;
			this.Fee = fee;

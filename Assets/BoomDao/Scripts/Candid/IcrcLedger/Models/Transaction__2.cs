...
namespace Candid.IcrcLedger.Models
{
	public class Transaction__2
	{
		...
		public Transaction__2(OptionalValue<Burn> burn, TxIndex index, string kind, OptionalValue<Mint> mint, Timestamp timestamp, OptionalValue<Transfer> transfer)
		{
			this.Burn = burn;
			this.Index = index;
			this.Kind = kind;
